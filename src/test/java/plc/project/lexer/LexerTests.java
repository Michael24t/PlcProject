...
public final class LexerTests {
    ...
    @ParameterizedTest
    @MethodSource
    void testFailedCharacter(String test, String input, boolean equals) {
        test(input, List.of(new Token(Token.Type.CHARACTER, input)), equals);
    }
    public static Stream<Arguments> testFailedCharacter() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource
    void testFailedString(String test, String input, boolean equals) {
        test(input, List.of(new Token(Token.Type.STRING, input)), equals);
    }
    public static Stream<Arguments> testFailedString() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource
    void testFailedInteraction(String test, String input, List<Token> expected) {
        test(input, expected, true);
    }

    public static Stream<Arguments> testFailedInteraction() {  //Just having problem with integer decimal relationship
        return Stream.of(
                ...
                Arguments.of("Number Exponent Decimal", "1e2.3", List.of(
                        new Token(Token.Type.INTEGER, "1"),
                        new Token(Token.Type.IDENTIFIER, "e"),
                        new Token(Token.Type.DECIMAL, "2.3")
                ))
        );
    }
